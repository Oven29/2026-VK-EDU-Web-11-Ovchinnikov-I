...
### Производительность
Результаты нагрузочного тестирования и анализ производительности Nginx + Gunicorn доступны в отдельном отчете:
**[Аналитический отчет по бенчмаркам](benchmarks/REPORT.md)**
